...
```mermaid
flowchart TD
    T["📘 <b>THESIS</b><br/>Cái rẻ là lao động, tiết kiệm quy đổi theo tỷ giá"]:::thesis
    A["⚔️ <b>ANTITHESIS</b><br/>Cái rẻ là phi mậu dịch; ai ăn rẻ thì tích lũy tăng"]:::antithesis
    X["🔍 <b>CROSS-EXAMINATION</b><br/>3 premises · 12-fallacy audit"]:::probe
    C["🌀 <b>TENSION</b><br/>Giá tiêu dùng hiện tại (PPP) vs giá tích lũy tương lai (FX)"]:::tension
    S["💎 <b>SYNTHESIS (AUFHEBEN)</b><br/>Ăn rẻ — tích trữ đắt: tiêu phi mậu dịch, giữ tài sản mậu dịch"]:::synthesis
    R["🌊 <b>RADIATING IMPLICATION</b><br/>Đặt cược vào hội tụ: mua tài sản phi mậu dịch bị định giá thấp"]:::ripple
...
```mermaid
flowchart LR
    A["<strong>ĂN</strong><br/>Tiêu dùng hiện tại<br/>đo bằng sức mua (PPP)"]
    B["<strong>TÍCH TRỮ</strong><br/>Tiết kiệm tương lai<br/>đo bằng ngoại tệ (FX)"]
    C["<strong>SỰ LỰA CHỌN GIỎ</strong><br/>Bạn đặt dòng tiền nào<br/>vào tầng giá nào?"]
    A -->|xung đột khi đo khác thước| B
    A -.->|được giải quyết bởi| C
    B -.->|được giải quyết bởi| C
    style C fill:#EDE9FE
```
